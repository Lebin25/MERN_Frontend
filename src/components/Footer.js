                    ...
                    <div className="col-4">
                        ...
                        <div>
                            <address className='text-white fs-6'>
                                Hoa Hai, Ngu Hanh Son, Da Nang City
                            </address>
                            <a href="tel:+84 123456789" className='mt-3 d-block mb-1 text-white'>
                                +84 123456789
                            </a>
                            <a href="mailto:fdigitic@gmail.com" className='mt-2 d-block mb-0 text-white'>
                                fdigitic@gmail.com
                            </a>
            ...
            <div className="container-xxl">
                <div className="row">
                    <div className="col-12">
                        <p className='text-center mb-0 text-white'>&copy; {new Date().getFullYear()}; Powered by 75Devils</p>
                    </div>
                </div>
            </div>
        </footer>
